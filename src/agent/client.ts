...
/** HTTP client for the open browser runtime daemon. */
...
export type HermesRuntimeClientOptions = RuntimeClientOptions;
/** @deprecated Use RuntimeClient */
export const HermesRuntimeClient = RuntimeClient;
